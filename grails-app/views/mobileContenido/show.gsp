...
<html>
	...
	<body>
		<a href="#show-mobileContenido" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<ol class="property-list mobileContenido">
				...
				<li class="fieldcontain">
					<span id="quienesSomos-label" class="property-label"><g:message code="mobileContenido.quienesSomos.label" default="Quienes Somos" /></span>
						...
						<span class="property-value" aria-labelledby="quienesSomos-label"><g:fieldValue bean="${mobileContenidoInstance}" field="quienesSomos"/></span>
